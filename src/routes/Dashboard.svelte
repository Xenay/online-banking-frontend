<script>
  ...
  <div class="">
    ...
    {#if !showConfirmLogout}
      <div>
        ...
        <div class="flex justify-center" >
          <div class="px-5"><button on:click={() => handleMenuSelection('logout')}>Logout</button></div>
          <div class=""><button on:click={() => handleMenuSelection('payment')}>Make a Payment</button></div> <!-- Payment button -->
    ...
    <button on:click={handleNewAccountClick} class="mt-5">Open New Account Form</button>
